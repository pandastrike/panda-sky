...
allowedHeaders = "Content-Type,X-Amz-Date,Authorization,X-Api-Key,X-Amz-Security-Token,Cache-Control,ETag,Last-Modified,Location"
exposedHeaders = "Content-Type,X-Amz-Date,Authorization,Cache-Control,ETag,Last-Modified,Location"
