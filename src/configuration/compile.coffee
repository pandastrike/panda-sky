# The configuration for Panda Sky deployments is broken into several files to make
# it more managable for humans.  But, we need to assemble it all into one
# configuration object when it's time to use it.  Panda Sky stores the requisite
